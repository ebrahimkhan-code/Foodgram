...
class Member2APIClient:
    ...
    def __init__(self, base_url: str = None):
        ...
        Args:
            base_url: API server URL. Defaults to MEMBER2_API_URL env var, else
                http://localhost:8001 (the service runs on 8001 so it does not
                collide with Member 1's Flask recommender on 8000).
        """
        if base_url is None:
            base_url = os.environ.get("MEMBER2_API_URL", "http://localhost:8001")
